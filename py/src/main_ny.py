...
text = ""
html_folha_en = requests.get("https://www.nytimes.com/")
...
custom_mask = np.array(Image.open(root_path + "imgs/north-america-black-white-vector-croped.jpg"))
wc = WordCloud(background_color="black", mask=custom_mask)
wc.generate(text_clean)
wc.to_file(root_path + 'imgs/test3-en.png')
